...
//extern void karatsuba256_branched(uint8_t *r, uint8_t *a, uint8_t *b);
//extern void karatsuba192_branched(uint8_t *r, uint8_t *a, uint8_t *b);
//extern void karatsuba160_branched(uint8_t *r, uint8_t *a, uint8_t *b);
//extern void karatsuba128_branched(uint8_t *r, uint8_t *a, uint8_t *b);
//extern void karatsuba96_branched(uint8_t *r, uint8_t *a, uint8_t *b);
//extern void karatsuba80_branched(uint8_t *r, uint8_t *a, uint8_t *b);
//extern void karatsuba64_branched(uint8_t *r, uint8_t *a, uint8_t *b);
//extern void karatsuba48_branched(uint8_t *r, uint8_t *a, uint8_t *b);
