...
//	unsigned int testy = 0xb4fc;


//	if(uniCode > 45632 )
//	{
//    	memset(&tMatrix[0], 0, sizeof(tMatrix));
//
//		if(GB2312_address(uniCode, tMatrix))
//		{
//        	memset(&tMatrix[0], 0, sizeof(tMatrix));
//			dtaLen = GT20L16.getMatrixUnicode(uniCode, tMatrix);
//		}
//		else
//		{
//			dtaLen = 32;
...
unsigned char ePaper::display()
{
    ...
    EPD.image_sd();
#elif defined(__AVR_ATmega1280__) || defined(__AVR_ATmega2560__)|| defined(__SAM3X8E__)|| defined(__SAM3A8C__)
