...
#ifdef PLATFORM_SPECIFIC_BIGMULTIPLY
...
void bigMultiplyVariableSizeNoModulo(uint8_t *r, uint8_t *op1, uint8_t op1_size, uint8_t *op2, uint8_t op2_size)
{
	...
	// and with the platforms this code is intended to run on, the Karatsuba
	// algorithm isn't significantly better.
	//	karatsuba256_branchfree(full_r, op1, op2);
	for (i = 0; i < op1_size; i++)
	{
		cached_op1 = op1[i];
		high_carry = 0;
...
//
//void bigMultiplyVariableSizeNoModulo_mod(uint8_t *r, uint8_t *op1, uint8_t op1_size, uint8_t *op2, uint8_t op2_size)
//{
//	uint8_t cached_op1;
//	uint8_t low_carry;
//	uint8_t high_carry;
...
//	// algorithm isn't significantly better.
//
//	if		(op1_size==32 && op2_size==32 && toggle){
//		karatsuba256_branched(r, op1, op2);
//	}else if(op1_size==24 && op2_size==24){
//		karatsuba192_branched(r, op1, op2);
//	}else if(op1_size==20 && op2_size==20){
//		karatsuba160_branched(r, op1, op2);
//	}else if(op1_size==16 && op2_size==16){
//		karatsuba128_branched(r, op1, op2);
//	}else if(op1_size==12 && op2_size==12){
//		karatsuba96_branched(r, op1, op2);
//	}else if(op1_size==10 && op2_size==10){
//		karatsuba80_branched(r, op1, op2);
//	}else if(op1_size==8 && op2_size==8){
//		karatsuba64_branched(r, op1, op2);
//	}else if(op1_size==6 && op2_size==6){
//		karatsuba48_branched(r, op1, op2);
//	}
//	else{
//		for (i = 0; i < op1_size; i++)
//		{
